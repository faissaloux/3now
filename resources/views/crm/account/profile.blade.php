...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
			...
			<h5 style="margin-bottom: 2em;"><i class="ti-write"></i>&nbsp;Profil aktualisieren</h5><hr>
            ...
            <form class="form-horizontal" action="{{route('crm.profile.update')}}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					<label for="mobile" class="col-xs-2 col-form-label">Mobiltelefon</label>
					<div class="col-xs-10">
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<button type="submit" class="btn btn-success shadow-box btn-rounded">Profil aktualisieren</button>
					</div>
				</div>
			</form>
		</div>
