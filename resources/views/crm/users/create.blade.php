...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
            <a href="{{ route('crm.user.index') }}" class="btn btn-default pull-right"><i class="fa fa-angle-left"></i> Zurück</a>

			<h5 style="margin-bottom: 2em;"><i class="ti-user"></i>&nbsp;Benutzer hinzufügen</h5><hr>

            <form class="form-horizontal" action="{{route('crm.user.store')}}" method="POST" enctype="multipart/form-data" role="form">
            	{{csrf_field()}}
				<div class="form-group row">
					<label for="first_name" class="col-xs-12 col-form-label">Vollständiger Name</label>
					<div class="col-xs-10">
						<input class="form-control" type="text" value="{{ old('first_name') }}" name="first_name" required id="first_name" placeholder="Full Name">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<input class="form-control" type="password" name="password_confirmation" id="password_confirmation" placeholder="Passwort erneut eingeben">
					</div>
				</div>
				...
				<div class="form-group row">
					<label for="mobile" class="col-xs-12 col-form-label">Mobiltelefon</label>
					<div class="col-xs-10">
						<input class="form-control" type="number" value="{{ old('mobile') }}" name="mobile" required id="mobile" placeholder="Mobiltelefon">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<button type="submit" class="btn btn-success btn-rounded shadow-box">Benutzer hinzufügen</button>
						<a href="{{route('crm.user.index')}}" class="btn btn-default">Stornieren</a>
					</div>
				</div>
			</form>
		</div>
