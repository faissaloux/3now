...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
    	    <a href="{{ route('admin.openTicket') }}" class="btn btn-default pull-right"><i class="fa fa-angle-left"></i> Zurück</a>
            ...
            <form class="form-horizontal" action="{{route('admin.transfer', $data->id )}}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					...
					<div class="col-xs-8">
						...
						<a href="{{route('admin.openTicket')}}" class="btn btn-default">Stornieren</a>
					</div>
				</div>
			</form>
		</div>
