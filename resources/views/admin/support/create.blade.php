...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
			...
			<h5 style="margin-bottom: 2em;"><i class="ti-exchange-vertical"></i>&nbsp; Support hinzufügen</h5><hr>
            ...
            <form class="form-horizontal" action="{{route('admin.support-manager.store')}}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					<label for="name" class="col-xs-12 col-form-label">Vollständiger Name</label>
					<div class="col-xs-10">
				...
				<div class="form-group row">
					<label for="password_confirmation" class="col-xs-12 col-form-label">Passwortbestätigung </label>
					<div class="col-xs-10">
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						...
						<a href="{{route('admin.support-manager.index')}}" class="btn btn-default">Stornieren</a>
					</div>
				</div>
			</form>
		</div>
