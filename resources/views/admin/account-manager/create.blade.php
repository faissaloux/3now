...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
			...
			<h5 style="margin-bottom: 2em;"><i class="ti-layout-grid2-thumb"></i>&nbsp;Account Manager hinzufügen</h5><hr>
            ...
            <form class="form-horizontal" action="{{route('admin.account-manager.store')}}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<button type="submit" class="btn btn-primary">Account Manager hinzufügen</button>
