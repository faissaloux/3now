    ...
    <div class="container-fluid">
    	<div class="box box-block bg-white">
           <!--  <a href="{{ route('admin.dispatch-manager.index') }}" class="btn btn-default pull-right"><i class="fa fa-angle-left"></i> Back</a> -->
			...
			<h5 style="margin-bottom: 2em;"><i class="ti-headphone"></i>&nbsp;Dispatcher hinzufügen<hr></h5>
            ...
            <form class="form-horizontal" action="{{route('admin.dispatch-manager.store')}}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<button type="submit" class="btn btn-primary">Dispatcher hinzufügen</button>
						<a href="{{route('admin.dispatch-manager.index')}}" class="btn btn-default">Stornieren</a>
					</div>
				</div>
			</form>
		</div>
