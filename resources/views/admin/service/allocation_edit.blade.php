...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <h5 style="margin-bottom: 2em;"><i class="ti-layout-media-overlay-alt-2"></i>&nbsp; Kartenfahrzeug aktualisieren</h5><hr>
            <form class="form-horizontal" action="{{route('admin.cabAllocation_update')}}" method="GET" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group row hidable" style="display:none">
                    <label for="provider_name" class="col-xs-12 col-form-label">Tarifprozentsatz für eine Person</label>
                    <div class="col-xs-10">
                        <input class="form-control" type="number" value="{{ old('one_passanger_percent') }}" name="one_passanger_percent" id="one_passanger_percent" >
                    </div>
                </div>
                <div class="form-group row hidable" style="display:none">
                    <label for="provider_name" class="col-xs-12 col-form-label">Tarifprozentsatz für zwei Personen</label>
                    <div class="col-xs-10">
                 ...
                 <div class="form-group row">
                    <label for="provider_name" class="col-xs-12 col-form-label">Fahrzeugliste</label>
                    <div class="col-xs-10">
                ...
                <div class="form-group row">
                    <label for="provider_name" class="col-xs-12 col-form-label">Tarifplan</label>
                    <div class="col-xs-10">
                    ...
                    <div class="col-xs-10">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-3">
                                <a href="{{ route('admin.allocation_list') }}" class="btn btn-danger btn-block">Stornieren</a>
                            </div>
