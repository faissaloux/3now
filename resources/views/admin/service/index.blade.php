...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            <h5 class="mb-1"><i class="ti-car"></i>&nbsp;Fahrzeugkategorie</h5><hr>
            <a href="{{ route('admin.service.create') }}" style="margin-left: 1em;" class="btn shadow-box btn-success btn-rounded pull-right"><i class="fa fa-plus"></i> Neues Fahrzeug hinzufügen</a>
