...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            <h5 class="mb-1"><span class="s-icon"><i class="ti-stats-up"></i></span>&nbsp;Neue Auszahlungsanforderung</h5>
            <hr/>
                    ...
                    <tr>
                        ...
                        <td>
                                ...
                                <button class="btn shadow-box btn-success btn-rounded w-min-sm m-b-0-25 waves-effect waves-light" data="{{ $service->id }}" id="approve_popup" 
                                    onclick="approve_popup({{$service->id}});">Einzelheiten</button>
                        </td>
                    </tr>
                @endforeach
                </tbody>
...
<td id="country"></td>
      ...
      <div class="modal-footer">
        <a type="button" id="ApprovedId" class="btn btn-primary " onclick="ApprovedId();"><span aria-hidden="true">Genehmigt</a>
      </div>
    </div>
  </div>
</div>
