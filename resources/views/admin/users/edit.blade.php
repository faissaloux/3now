...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
			...
			<h5 style="margin-bottom: 2em;"><i class="ti-user"></i>&nbsp;Benutzer aktualisieren</h5><hr>
		...
		<div class="box box-block bg-white">
    	    <a href="{{ route('admin.user.index') }}" class="btn btn-default pull-right"><i class="fa fa-angle-left"></i> Zurück</a>

			<h5 style="margin-bottom: 2em;">Benutzerpasswort aktualisieren</h5>
