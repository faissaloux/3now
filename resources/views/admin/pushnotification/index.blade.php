    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            ...
            <div class="box box-block bg-white">
                <h5 class="mb-1"><i class="ti-comments"></i>&nbsp; Push-Benachrichtigung <hr></h5>
                <a href="{{ route('admin.pushnotification.create') }}" style="margin-left: 1em;" class="btn btn-success btn-rounded pull-right"><i class="fa fa-plus"></i> Neue Push-Benachrichtigung hinzufügen</a>
                <table class="table table-striped table-bordered dataTable" id="table-2" style="width:100%;">
                    <thead>
                        <tr>
                            ...
                            <th>Art</th>
                            <th>Titel</th>
                            <th>Benachrichtigungstext</th>
                            <th>Haltbarkeitsdatum</th>
                            <th>Aktion</th>
                        </tr>
                    </thead>
                    <tbody>
