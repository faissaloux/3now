...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
			...
			<h5 style="margin-bottom: 2em;"><i class="ti-comments"></i>&nbsp;Benachrichtigung senden</h5><hr>
            ...
            <form class="form-horizontal" action="{{route('admin.pushnotification.store')}}" method="POST" enctype="multipart/form-data" role="form">
            	...
            	<div class="form-group row">
					<label for="type" class="col-xs-12 col-form-label">Art</label>
					<div class="col-xs-10">
						<select name="zone" class="form-control" id="zone" required="">
						    <option value="0">Wähle ein</option>
							<option value="1">Allgemeines</option>
							<option value="2">Ortsbasierend</option>
					    </select>
					</div>
				</div>
				...
				<div class="form-group row">
					<label for="email" class="col-xs-12 col-form-label">Titel</label>
					<div class="col-xs-10">
				...
				<div class="form-group row">
					<label for="notification_text" class="col-xs-12 col-form-label">Benachrichtigungstext</label>
					<div class="col-xs-10">
				...
				<div class="form-group row">
					<label for="email" class="col-xs-12 col-form-label">Haltbarkeitsdatum</label>
					<div class="col-xs-10">
				...
				<div class="form-group row">
					<label for="email" class="col-xs-12 col-form-label"><div class="col-xs-10"><input type="checkbox" class="form-check-input" id="show_in_promotion" name="show_in_promotion"  value="1">In der Promotion anzeigen</div></label>
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						...
						<a href="{{route('admin.pushnotification.index')}}" class="btn btn-default">Stornieren</a>
					</div>
				</div>
			</form>
		</div>
