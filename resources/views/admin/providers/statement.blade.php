            	...
            	<div class="row">
                    <div class="col-lg-4 col-md-6 col-xs-12">
						<div class="box box-block bg-danger mb-2 shadow-box">
							<div class="t-content">
								<h6 class="text-uppercase mb-1">Gesamtfahrt</h6>
					...
					<div class="col-lg-4 col-md-6 col-xs-12">
						<div class="box box-block bg-success mb-2 shadow-box">
							...
							<div class="t-content">
								<h6 class="text-uppercase mb-1">Einnahmen</h6>
	            	...
	            	<div class="col-lg-4 col-md-6 col-xs-12">
						<div class="box box-block bg-danger mb-2 shadow-box">
							...
							<div class="t-content">
								<h6 class="text-uppercase mb-1">Alle Kommission</h6>
					...
					<div class="col-lg-4 col-md-6 col-xs-12">
						<div class="box box-block bg-success mb-2 shadow-box">
							...
							<div class="t-content">
								<h6 class="text-uppercase mb-1">Alles verdienen</h6>
					...
					<div class="col-lg-4 col-md-6 col-xs-12">
						<div class="box box-block bg-warning mb-2 shadow-box">
							<div class="t-content">
								<h6 class="text-uppercase mb-1">Abgebrochene Fahrten</h6>
