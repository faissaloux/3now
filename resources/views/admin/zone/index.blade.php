    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            ...
            <div class="box box-block bg-white">
                <h5 class="mb-1"><span class="s-icon"><i class="ti-zoom-in"></i></span> &nbsp;Zonen </h5>
                <hr/>
                <a href="{{ route('admin.zone.create') }}" style="margin-left: 1em;" class="btn shadow-box btn-success btn-rounded w-min-sm m-b-0-25 waves-effect waves-light pull-right"><i class="fa fa-plus"></i> Neuen Standort hinzufügen</a>
