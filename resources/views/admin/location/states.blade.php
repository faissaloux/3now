    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            ...
            <div class="box box-block bg-white">
                <h5 class="mb-1"><i class="ti-map"></i>&nbsp;Staaten <hr></h5>
                <a href="{{ route('admin.location.create') }}" style="margin-left: 1em;" class="btn shadow-box btn-success btn-rounded pull-right"><i class="fa fa-plus"></i> Status hinzufügen</a>
