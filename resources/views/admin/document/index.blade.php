    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            ...
            <div class="box box-block bg-white">
                <h5 class="mb-1"><i class="ti-layout-tab"></i>&nbsp;Unterlagen</h5><hr>
                <a href="{{ route('admin.document.create') }}" style="margin-left: 1em;" class="btn shadow-box btn-success btn-rounded pull-right"><i class="fa fa-plus"></i> Neues Dokument hinzufügen</a>
