...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
			...
			<h5 style="margin-bottom: 2em;"><i class="ti-layout-tab"></i>&nbsp;Dokument aktualisieren</h5><hr>
            ...
            <form class="form-horizontal" action="{{route('admin.document.update', $document->id )}}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					<label for="name" class="col-xs-2 col-form-label">Dokumentname</label>
					<div class="col-xs-10">
                ...
                <div class="form-group row">
                    <label for="name" class="col-xs-2 col-form-label">Dokumententyp</label>
                    <div class="col-xs-10">
                        <select name="type">
                 ...
                 <div class="form-group row">
                    <label for="name" class="col-xs-2 col-form-label">Dokument läuft in Tag (en) ab</label>
                    <div class="col-xs-10">
                        <select name="expire">
                            @for($i=1;$i<=30;$i++)
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<button type="submit" class="btn btn-primary">Dokument aktualisieren</button>
