...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            <h5 class="mb-1">
                <i class="ti-rocket"></i>&nbsp;Anbieter<hr>
               </h5>
            <a href="{{ route('admin.fleet.create') }}" style="margin-left: 1em;" class="btn shadow-box btn-success pull-right btn-rounded"><i class="fa fa-plus"></i> Neue Anbieter hinzufügen</a>
