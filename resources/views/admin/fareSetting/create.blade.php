...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
			<h5><i class="ti-layout-media-overlay"></i>&nbsp;Tarifeinstellungen</h5><hr>
<!--{{ route('admin.fare.settings.store') }}-->
            <form class="form-horizontal"  action="{{ route('admin.fare.settings.store') }}" method="POST" enctype="multipart/form-data" role="form">
            	{{csrf_field()}}
					...
					<label for="site_title" class="col-xs-2 col-form-label">Name des Tarifplans</label>
					<div class="col-xs-10">
                ...
                <div class="form-group row">
                    <label for="tax_percentage" class="col-xs-2 col-form-label">Bis zu KM</label>
                    <div class="col-xs-10">
				...
				<div class="form-group row">
					<label for="store_link_android" class="col-xs-2 col-form-label">Preis pro KM</label>
					<div class="col-xs-10">
				...
				<div class="form-group row">
					<label for="store_link_ios" class="col-xs-2 col-form-label">Wartepreis pro Minute</label>
					<div class="col-xs-10">
				...
				<div class="form-group row">
					<label for="store_link_ios" class="col-xs-2 col-form-label">Spitzenpreis anwenden</label>
				     	<div class="col-xs-10">
                ...
                <div class="form-group row" style="margin-left: -32px;font-size: 15px;font-weight: bold;">
					...
					<div class="col-xs-10">
					<label for="store_link_ios" class="col-xs-2 col-form-label">Details zum Höchstpreis</label>
					</div>
				</div>
                ...
                <div class="form-group row">
					...
					<div  id="peakAdded">
                     ...
                     <br/>
                     	...
                     	<div class="form-group row">
					<label for="store_link_ios" class="col-xs-2 col-form-label">Nachttarif anwenden</label>
				     	<div class="col-xs-10">
					...
					<label for="store_link_ios" class="col-xs-2 col-form-label"></label>
					<div class="col-xs-10">
					<label for="store_link_ios" class="col-xs-2 col-form-label">Details zum Nachttarif</label>
					</div>
				</div>
				...
				<div class="form-group row">
                    <div class="col-xs-12 col-sm-6 offset-md-2 col-md-3">
                    	<a href="{{route('admin.fare_settings')}}" class="btn btn-danger">Stornieren</a>
						<button type="submit" class="btn btn-primary" id="alertbox">speichern</button>
					</div>
				</div>
			</form>
		</div>
