...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            <h5 class="mb-1"><i class="ti-layout-media-overlay"></i>&nbsp;Tarifeinstellungen </h5><hr>
            <a href="{{ route('admin.fare.settings.create') }}" style="margin-left: 1em;" class="btn shadow-box btn-success btn-rounded pull-right"><i class="fa fa-plus"></i> Neuen Plan hinzufügen</a>
            <table class="table table-striped table-bordered dataTable" id="table-2"  style="width: 100%">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Name des Tarifplans</th>
                        <th>Von km</th>
                        <th>BIS KM</th>
                        <th>Preis pro km</th>
                        <th>Wartepreis pro min</th>
                        <th>Hauptverkehrszeit</th>
                        <th>Spät in der Nacht</th>
                        <th>Aktion</th>
                    </tr>
