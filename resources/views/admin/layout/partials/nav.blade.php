      ...
      <ul class="sidebar-menu">
            ...
            <ul>
               ...
               <li class="with-sub">
                  ...
                  <ul>
                     ...
                     <li><a href="{{ url('admin/new_account') }}">Neues Konto</a></li>

                     <li><a href="{{ url('admin/approved_account') }}">Genehmigtes Konto</a></li>
               ...
               <li class="with-sub">
                  ...
                  <ul>
                     ...
                     <li><a href="{{ url('admin/new_withdraw') }}">Anfragen zurückziehen</a></li>

                     <li><a href="{{ url('admin/approved_withdraw') }}">Genehmigter Rückzug</a></li>
         ...
         <li class="with-sub">
            ...
            <ul>
               ...
               <li><a href="{{ route('admin.zone.index') }}">Alle Zone</a></li>

               <li><a href="{{ route('admin.zone.create') }}">Zone hinzufügen</a></li>
         ...
         <li class="with-sub">
            ...
            <ul>
               ...
               <li><a href="{{ route('admin.pushnotification.index') }}">Alle Push-Benachrichtigungen</a></li>

               <li><a href="{{ route('admin.pushnotification.create') }}">Push-Benachrichtigung hinzufügen</a></li>
         ...
         <li class="with-sub">
            ...
            <ul>
               ...
               <li><a href="{{ route('admin.user.index') }}">Alle Benutzer</a></li>

               <li><a href="{{ route('admin.user.create') }}">Nutzer hinzufügen</a></li>
         ...
         <li class="with-sub">
            ...
            <ul>
               ...
               <li><a href="{{ route('admin.provider.index') }}">Alle Fahrer</a></li>

               <li><a href="{{ route('admin.provider.create') }}">Treiber hinzufügen</a></li>
         ...
         <li class="with-sub">
            ...
            <ul>
               ...
               <li><a href="{{ route('admin.dispatch-manager.index') }}">Alle Dispatcher</a></li>

               <li><a href="{{ route('admin.dispatch-manager.create') }}">Dispatcher hinzufügen</a></li>
         ...
         <li class="with-sub">
            ...
            <ul>
               ...
               <li><a href="{{ route('admin.fleet.index') }}">Anbieter auflisten</a></li>

               <li><a href="{{ route('admin.fleet.create') }}">Neuen Anbieter hinzufügen</a></li>
         ...
         <li class="with-sub">
            ...
            <ul>
               ...
               <li><a href="{{ route('admin.account-manager.index') }}">Alle Konten</a></li>

               <li><a href="{{ route('admin.account-manager.create') }}">Konto hinzufügen</a></li>
         ...
         <li class="with-sub">
            ...
            <ul>
               ...
               <li><a href="{{ route('admin.ride.statement') }}">Reiseeinnahmen</a></li>

               <li><a href="{{ route('admin.payment') }}">Reiseverlauf</a></li>

               <li><a href="{{ route('admin.ride.statement.provider') }}">Fahrer verdienen</a></li>

               <li><a href="{{ route('admin.ride.statement.today') }}">Tägliche Einnahmen</a></li>

               <li><a href="{{ route('admin.ride.statement.monthly') }}">Monatliche Einnahmen</a></li>

               <li><a href="{{ route('admin.ride.statement.yearly') }}">Jahresumsatz</a></li>
         ...
         <li class="with-sub">
            ...
            <ul>
               ...
               <li><a href="{{ route('admin.user.review') }}">Benutzerbewertungen</a></li>

               <li><a href="{{ route('admin.provider.review') }}">Treiberbewertungen</a></li>
         ...
         <li class="with-sub">
            ...
            <ul>
               ...
               <li><a href="{{ route('admin.service.index') }}">Alle Fahrzeuge</a></li>

               <li><a href="{{ route('admin.service.create') }}">Fahrzeug hinzufügen</a></li>
         ...
         <li class="with-sub">
            ...
            <ul>
               ...
               <li><a href="{{ url('admin/allocation_list') }}">Kartiertes Fahrzeug</a></li>

               <li><a href="{{ url('admin/allocation') }}">Neue Karte</a></li>
         ...
         <li class="with-sub">
            ...
            <ul>
               ...
               <li><a href="{{ route('admin.fare_settings') }}">Tarifplanliste</a></li>

               <li><a href="{{ route('admin.fare.settings.create') }}">Neuen Tarifplan hinzufügen</a></li>
         ...
         <li class="with-sub">
            ...
            <ul>
               ...
               <li><a href="{{ route('admin.support-manager.index') }}">Alle Executive</a></li>

               <li><a href="{{ route('admin.support-manager.create') }}">Neue Führungskraft hinzufügen</a></li>
            ...
            <ul>
               ...
               <li><a href="{{ route('admin.openTicket') }}">Offenes Ticket</a></li>

               <li><a href="{{ route('admin.closeTicket') }}">Ticket schließen</a></li>
         ...
         <li class="with-sub">
            ...
            <ul>
               ...
               <li><a href="{{ route('admin.document.index') }}">Alle Dokumente</a></li>

               <li><a href="{{ route('admin.document.create') }}">Dokument hinzufügen</a></li>
         ...
         <li class="with-sub">
            ...
            <ul>
               ...
               <li><a href="{{ route('admin.country.index') }}">Alle Länder</a></li>

               <li><a href="{{ route('admin.state.index') }}">Alle Staaten</a></li>

               <li><a href="{{ route('admin.city.index') }}">Alle Städte</a></li>

               <li><a href="{{ route('admin.location.create') }}">Neue hinzufügen</a></li>
         ...
         <li class="with-sub">
            ...
            <ul>
               ...
               <li><a href="{{ url('/admin/page') }}">Alle Seiten</a></li>

               <li><a href="{{ url('/admin/page/create') }}">Seiten hinzufügen</a></li>

               <li><a href="{{ route('admin.cms-manager.index') }}">CMS Exekutive</a></li>

               <li><a href="{{ route('admin.cms-manager.create') }}">Neue Exekutive hinzufügen</a></li>
               ...
               <li><a href="{{ url('/admin/blog') }}">Alle Blogs</a></li>

               <li><a href="{{ url('/admin/page/create') }}">Neue Blogs hinzufügen</a></li>
         ...
         <li class="with-sub">
            ...
            <ul>
               ...
               <li><a href="{{ route('admin.crm-manager.index') }}">CRM Exekutive</a></li>

               <li><a href="{{ route('admin.crm-manager.create') }}">Neue Exekutive hinzufügen</a></li>
         ...
         <li class="with-sub">
            ...
            <ul>
               ...
               <li><a href="{{ route('admin.testimonial.index') }}">Testimonials auflisten</a></li>

               <li><a href="{{ route('admin.testimonial.create') }}">Neues Testimonial hinzufügen</a></li>
