...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
			...
			<h5 style="margin-bottom: 2em;"><span class="s-icon"><i class="ti-car"></i></span>&nbsp;Add Provider</h5><hr>

            <form class="form-horizontal" action="{{route('fleet.provider.store')}}" method="POST" enctype="multipart/form-data" role="form">
            	{{csrf_field()}}
				<div class="form-group row">
					<label for="first_name" class="col-xs-12 col-form-label">Full Name</label>
					<div class="col-xs-10">
