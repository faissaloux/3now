		...
		<div class="row">
			<div class="col-md-4">
				<div class="box card card-block" id="create-ride">
					<form id="form-create-ride"  method="POST">
						...
						<div class="row">
							<div class="col-xs-6">
								<button type="button" class="btn btn-lg btn-danger btn-block waves-effect  waves-light form_create_ride_reset_btn shadow-box">RESET</button>
							</div>
							<div class="col-xs-6">
								<button class="btn btn-lg btn-success btn-block waves-effect waves-light shadow-box">Next</button>
							</div>
						</div>
					</form>
				</div>
			...
			<div class="col-md-8">
				<div class="card my-card">
					...
					<div class="col-md-3">						        
					<div style="margin-top:5px;font-size: 16px;"><input type="checkbox" name="vehicle1" value="Bike"> On Going Ride</div>
					</div>								
					<div class="col-md-3">						        
					<div style="margin-top:5px;font-size: 16px;"><input type="checkbox" name="vehicle1" value="Bike"> Active Driver</div>								
					</div>								
					<div class="col-md-6">						        
