...
<script>
    ...
    var googleMarkers = [];
    var mapIcons = {
        user: '{{ asset("asset/front_dashboard/img/marker-user.png") }}',
        active: '{{ asset("asset/front_dashboard/img/car.png") }}',
        riding: '{{ asset("asset/front_dashboard/img/car-active.png") }}',
        offline: '{{ asset("asset/front_dashboard/img/car-offline.png") }}',
        unactivated: '{{ asset("asset/front_dashboard/img/car-unactivated.png") }}'
    }
