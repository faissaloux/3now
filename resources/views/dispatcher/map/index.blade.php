...
<script>
    ...
    var current_lat		 =	28.5850;
    var current_long     =	77.3116;
...
<script src="https://maps.googleapis.com/maps/api/js?key={{ env('GOOGLE_MAP_KEY_WEB') }}&libraries=geometry&callback=LiveTrackingInitMap" async defer></script>
