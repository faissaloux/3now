...
<table  dir="ltr" style="disblay:block; max-width:790px; min-width: 790px !important; margin:0 auto;">
      <tbody><tr>
        <td>  Fahrername </td>
        <td class="price" style="text-align: right;"> {{ $full_order->provider->first_name }} </td>
      </tr>
      <tr>
        <td>
        Handynummer   </td>
        <td class="price" style="text-align: right;"> {{ $full_order->provider->mobile }} </td>
      </tr>
      <tr>
        <td>Email  </td>
        <td class="price" style="text-align: right;">{{ $full_order->provider->email }}</td>
      </tr>
    </tbody>
  </table>
...
<table  dir="ltr" style="disblay:block; max-width:790px; min-width: 790px !important; margin:0 auto;">
  <tbody>
    <tr>
        ...
        <tr>
        <td><b>Fahrpreis</b> </td>
        <td class="price" style="text-align: right;">   <b> {{ $full_order->pries() }} €  </b> </td>
      </tr>
      <tr>
