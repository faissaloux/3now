   ...
   <div class="container">
      ...
      <div class="row">
                                 ...
                                 <div class="right-navbar">
                                    ...
                                    <div class="nav-bar">
                                       ...
                                       <ul>
                                          ...
                                          <li><a href="{{url('ride_overview')}}">Overview</a></li>

                                          <li><a href="{{url('how_it_works')}}">How it Works</a></li>

                                          <li><a href="{{url('fare_estimate')}}">Fare Estimator</a></li>

                                          <li><a href="{{url('ride_safety')}}">Safety</a></li>
                                 ...
                                 <div class="left-navbar">
                                    ...
                                    <div class="nav-bar">
                                       ...
                                       <ul>
                                          ...
                                          <li><a href="{{url('drive_overview')}}">Overview</a></li>

                                          <li><a href="{{url('requirements')}}">Requirements</a></li>

                                          <li><a href="{{url('driver_app')}}">Driver App</a></li>

                                          <li><a href="{{url('vehicle_solutions')}}">Vehicle Solutions</a></li>

                                          <li><a href="{{url('drive_safety')}}">Safety</a></li>

                                          <li><a href="{{url('local')}}">Local Driver Guide</a></li>
                  ...
                  <div class="eats">
                     ...
                     <div class="container">
                        ...
                        <ul>
                           ...
                           <li><a href="{{url('myliftx')}}">Mylift  X</a></li>
         ...
         <div class="col-md-2 right-padding">
            ...
            <a href="{{ url('/') }}"><img src="https://i.imgur.com/PsD6WKp.png" height="100%" style="margin-top: 7%;"/></a>                    
         ...
         <div class="col-md-5 help">
            ...
            <div class="right"  style="float:right;">
               ...
               <ul class="hidden-xs">
                  ...
                  <li><a href="{{url('/PassengerSignin')}}">anmelden</a></li>
               ...
               <a href="{{ url('/provider/register') }}" class="btn btn-default button-shadow">Fahrer werden</a>                        
