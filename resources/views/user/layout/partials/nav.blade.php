            ...
            <ul class="sidebar-menu">
                ...
                <li style="display: none;">
                    <a href="{{url('dashboard')}}" class="waves-effect waves-light">
                        <span class="s-icon"><i class="ti-dashboard user-sidebaricon"></i></span>
                ...
                <li>
                    <a href="{{url('mytrips')}}" class="waves-effect waves-light">
                        <span class="s-icon"><i class="ti-map-alt user-sidebaricon"></i></span>
                ...
                <li>
                    <a href="{{url('/helppage')}}" class="waves-effect waves-light">
                        <span class="s-icon"><i class="ti-help user-sidebaricon"></i></span>
                        <!--span class="s-text user-dashboard">Hilfe</span-->
                        <span class="s-text user-dashboard">Hilfe</span>
                    </a>
                </li>
				<!--
