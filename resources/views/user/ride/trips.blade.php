...
<div class="col-md-12" style="margin-bottom: 20px;">
    ...
    <div class="dash-content">
        <div class="row no-margin">
            <div class="col-md-12">
                <h4 class="page-title"><!--@lang('user.ride.ride_now')--><span class="s-icon"><i class="ti-calendar user-sidebaricon" style="color: rgb(0, 0, 0);"></i></span>&nbsp; Neue Fahrt</h4>
            </div>
        </div>
            ...
            <div class="col-md-6">
                ...
                <form action="{{url('confirm/ride')}}" method="GET" onkeypress="return disableEnterKey(event);" class="tripsform">
                    ...
                    <div class="input-group dash-form" style="max-width:inherit">
                        ...
                        <input type="text" class="form-control fontsize" id="origin-input" name="s_address"  placeholder="Geben Sie den Abholort ein" value="{{ session('s_address') }}">
                    </div>

                    <div class="input-group dash-form" style="max-width:inherit">
                        <div class="input-group-addon"><span class="ti-location-pin"></span></div>
                        <input type="text" class="form-control fontsize" id="destination-input" name="d_address"  placeholder="Geben Sie das ziel ein" value="{{ session('d_address') }}">
                    </div>
                    ...
                    <button type="submit"  class="full-primary-btn btn-success box-shadow fare-btn"><!--@lang('user.ride.order_now')--> Fahrt Bestätigen</button>
    ...
    <div class="dash-content" style="margin-top: 20px;">
        <div class="row no-margin">
            <div class="col-md-12">
                <h4 class="page-title">Letzte Fahrt</h4>
            </div>
        </div>
        ...
        <div class="row no-margin ride-detail">
            ...
            @if($trips->count() > 0)
                ...
                @else
                    <hr>
                    <p style="text-align: center;">Keine Fahrten verfügbar</p>
                @endif
            </div>
        </div>
