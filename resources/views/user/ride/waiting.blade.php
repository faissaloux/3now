    ...
    <div class="dash-content">
		...
		<div class="row no-margin">
		    <div class="col-md-12">
		        ...
		        <img src="asset/img/location_waves.gif" alt="img" style="width: 50px;" />
		    </div>
		</div>
		...
		var SwitchState = React.createClass({
			...
			render: function(){
				...
				if(this.props.checkState != ""){
					...
					}else if((this.props.checkState.status == 'DROPPED' || this.props.checkState.status == 'COMPLETED') && this.props.checkState.payment_mode == 'Bargeld' && this.props.checkState.paid == 0){
						return (
							<div>
