...
<div class="col-md-12" style="margin-bottom: 20px;">
    <div class="dash-content">
        ...
        <div class="row no-margin payment">
            <div class="col-md-12">
                <h5 class="btm-border"><strong></strong> 
                ...
                <div class="pay-option">
                    <h6><img src="{{asset('asset/front/img/cash-icon.png')}}"> @lang('user.cash') </h6>
                </div>
                @if(Setting::get('CARD') == 1)
                @foreach($cards as $card)
                <div class="pay-option">
                    <h6>
                        <img src="{{asset('asset/front/img/card-icon.png')}}"> {{$card->brand}} **** **** **** {{$card->last_four}} 
                        @if($card->is_default)
