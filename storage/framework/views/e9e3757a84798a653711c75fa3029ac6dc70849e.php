   ...
   <div class="container">
      ...
      <div class="row">
                                 ...
                                 <div class="right-navbar">
                                    ...
                                    <div class="nav-bar">
                                       ...
                                       <ul>
                                          ...
                                          <li><a href="<?php echo e(url('ride_overview')); ?>">Overview</a></li>

                                          <li><a href="<?php echo e(url('how_it_works')); ?>">How it Works</a></li>

                                          <li><a href="<?php echo e(url('fare_estimate')); ?>">Fare Estimator</a></li>

                                          <li><a href="<?php echo e(url('ride_safety')); ?>">Safety</a></li>
                                 ...
                                 <div class="left-navbar">
                                    ...
                                    <div class="nav-bar">
                                       ...
                                       <ul>
                                          ...
                                          <li><a href="<?php echo e(url('drive_overview')); ?>">Overview</a></li>

                                          <li><a href="<?php echo e(url('requirements')); ?>">Requirements</a></li>

                                          <li><a href="<?php echo e(url('driver_app')); ?>">Driver App</a></li>

                                          <li><a href="<?php echo e(url('vehicle_solutions')); ?>">Vehicle Solutions</a></li>

                                          <li><a href="<?php echo e(url('drive_safety')); ?>">Safety</a></li>

                                          <li><a href="<?php echo e(url('local')); ?>">Local Driver Guide</a></li>
                  ...
                  <div class="eats">
                     ...
                     <div class="container">
                        ...
                        <ul>
                           ...
                           <li><a href="<?php echo e(url('myliftx')); ?>">Mylift  X</a></li>

                           <li><a href="<?php echo e(url('myliftxl')); ?>">Mylift  XL</a></li>

                           <li><a href="<?php echo e(url('myliftxxl')); ?>">Mylift  XXL</a></li>
         ...
         <div class="col-md-2 right-padding">
            ...
            <a href="<?php echo e(url('/')); ?>"><img src="https://i.imgur.com/PsD6WKp.png" height="100%" style="margin-top: 7%;"/></a>                    
         ...
         <div class="col-md-5 help">
            ...
            <div class="right"  style="float:right;">
               ...
               <ul class="hidden-xs">
                  ...
                  <li><a href="<?php echo e(url('/PassengerSignin')); ?>">anmelden</a></li>

                  <?php else: ?> 

                  <li><a href="<?php echo e(url('/logout')); ?>" onclick="event.preventDefault();

                     document.getElementById('logout-form').submit();">Ausloggen</a></li>
               ...
               <div class="driver-btn" style="color: #32B0E9">                            

               <a href="<?php echo e(url('/provider/register')); ?>" class="btn btn-default button-shadow">Fahrer werden</a>                        
