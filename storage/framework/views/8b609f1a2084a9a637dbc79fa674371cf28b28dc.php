        ...
        <div class="col-md-4">
            <form role="form" method="POST" action="<?php echo e(url('/register')); ?>">
                    <?php echo e(csrf_field()); ?>
                      ...
                      <label style="margin-top: inherit;">Name</label>
                      <input id="name" type="text" class="form-control" name="first_name" value="" placeholder="Name" autofocus="">
                      ...
                      <input type="text" autofocus="" id="phone_number" class="form-control" placeholder="Mobile Number" name="phone_number" value="">
          ...
          <div class="facebook_btn">
                     <h5>Already Account?<a class="log-blk-btn" href="<?php echo e(url('/PassengerSignin')); ?>">  Click Here</a></h5>
                    </div>           
            </form>
    </div>
         <div class="col-md-8">
...
<?php $__env->startSection('noscripts'); ?>
