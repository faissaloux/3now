...
Route::get('/open-ticket', 'Resource\SupportResource@openTicket')->name('openTicket');
Route::get('/close-ticket', 'Resource\SupportResource@closeTicket')->name('closeTicket');
Route::get('/open-ticket-details/{id}', 'Resource\SupportResource@openTicketDetails')->name('openTicketDetails');
Route::patch('/transfer/{id}', 'Resource\SupportResource@transfer')->name('transfer');
