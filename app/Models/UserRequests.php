...
class UserRequests extends Model
{
     ...
     */
    public function Kindersitz_cash()
    {
        if($this->kindersitz > 1 ){
            return (($this->kindersitz * 5 ) - 5);
        }else {
            return 0 ;
        }    }
    
    public function Babyschale_cash()
    {
        if($this->babyschale > 1 ){
            return (($this->babyschale * 10 ) - 10 );
        } else {
            return 0 ;
        }
    }
    
    public function Namenscheild_cash()
    {
        
        if ($this->nameschield == '1' or $this->nameschield == 'true') {
            return  15;
        }else {
            return 0 ;
        } 
    ...
    public function pries()
    {
        ...
        if($this->babyschale > 1 ){
            $price = $price + (($this->babyschale * 10 ) - 10 );
        }
        if($this->kindersitz > 1 ){
            $price = $price + (($this->kindersitz * 5 ) - 5);
        }
