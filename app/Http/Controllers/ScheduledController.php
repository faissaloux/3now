    ...
    public function payment(Request $request) {
        ...
        public function stripePost(Request $request){
            ...
            $charge = \Stripe\Charge::create ([
                    "amount" => round($request->input( 'price' )),
                    "currency" => "usd",
                        ...
                        try{
                           ...
                           if($request->service_type == '19'){
							...
							if($request->has('schedule_date'))    {							
								...
								return response()->json(['error' => 'quite'. $UserRequest->id]);
								return response()->json(['error' => $UserRequest->id]);

								return	$this->invoice($UserRequest->id);	
							}else {
								return response()->json(['error' => 'i dont have it']);
							}
							*/
