   ...
   public function payment(Request $request)
    {
        ...
        $this->validate($request, [
                'request_id' => 'required|exists:user_request_payments,request_id|exists:user_requests,id,user_id,'.Auth::user()->id,
            ]);
             ...
             Session::put('request_id',$request->request_id);
         	 ...
         	 $RequestPayment = UserRequestPayment::where('request_id',$request->request_id)->first(); 
         	      ...
         	      $total_amount =$RequestPayment->total;
			        ...
			        $redirect_urls->setReturnUrl(URL::route('papal.payment.status')) /** Specify return URL **/
			            ->setCancelUrl(URL::route('papal.payment.status'));
        ...
        if($UserRequest->payment_mode == 'CARD') {
            ...
            try {
                ...
                $Charge = Charge::create(array(
                      ...
                      "card" => $Card->card_id,
                      "description" => " Payment Charge for 3now :".Auth::user()->email,
    ...
    public function paymentStripe(Request $request)
    {
        ...
        if(
            ...
            and !empty($request->payment_id) 
           // and !empty($request->total_payment)
        )
