...
class SupportResource extends Controller
{
    ...
    {
        try {
            $supports = SupportUser::findOrFail($id);
            return view('admin.support.edit',compact('supports'));
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('admin.support.index')->with('flash_success', 'SupportUser Updated Successfully');    
        } 
    ...
    public function closeTicket(){
        ...
        $data = Complaint::where('transfer','!=',0)->where('status',0)->get();
