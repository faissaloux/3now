...
class FirebaseController extends Controller {
    public function msg() {
        ...
        $firebase = (new Factory)->withServiceAccount($serviceAccount)->withDatabaseUri('https://laravel-420a9.firebaseio.com/')->create();
        $database = $firebase->getDatabase();
        $database->getReference('chats')->set(['client_msg' => 'Post title', ]);
    }
