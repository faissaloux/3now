...
class DevController extends Controller {
    ...
    public function testNotification() {
        ...
        $notification = ['title' => '3now title', 'body' => '3now text body', 'sound' => 1, "sound" => "default", "click_action" => "Open_URI"];
        ...
        $fcmNotification = ['to' => $token, 'notification' => $notification, 'data' => ["uri" => "lld", "msg_type" => "Hello ", "request_id" => 7, "image_url" => 'https://www.gstatic.com/mobilesdk/160503_mobilesdk/logo/2x/firebase_28dp.png', "user_name" => "abdulwahab", "msg" => "msg"]];
